                        ...
                        <View style={styles.card}>
                            <View style={styles.switchRow}>
                                <View style={styles.switchLabelContainer}>
                                    ...
                                    <View>
                                        <Text style={styles.switchLabel}>Recordatorios</Text>
                                        <Text style={styles.switchSubLabel}>
                                            Reciba una notificación cuando sea el momento de tomar su medicamento
                                        </Text>
                                    </View>
                                </View>
                                <Switch
                            ...
                            <View style={styles.switchRow}>
                                <View style={styles.switchLabelContainer}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={styles.switchSubLabel}>
                                            Recibe una notificación cuando necesites recargar
                                        </Text>
                                    </View>
                                </View>
                                <Switch
                    ...
                    >
                        ...
                        >
                            <Text style={styles.saveButtonText}>
                                {isSubmitting ? "Agregar..." : "Agregar Medicamento"}
                            </Text>
                        </LinearGradient>
                    </TouchableOpacity>
                    <TouchableOpacity
